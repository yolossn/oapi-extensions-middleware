...
type ClientInterface interface {
	// Test request
	Test(ctx context.Context) (*http.Response, error)
}

func (c *Client) Test(ctx context.Context) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	// Test request
	TestWithResponse(ctx context.Context) (*TestResponse, error)
}
...
func (c *ClientWithResponses) TestWithResponse(ctx context.Context) (*TestResponse, error) {
	rsp, err := c.Test(ctx)
	if err != nil {
		return nil, err
	}
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/1yPwVLDMAxEfyWzZ7cNcPMfcOcHjCOIOomssQSUyfjfGbvDpSfZWu/z7oFcdi1C4oZ4",
	"tACWj4J4wNk3QkRJyie6OYlxEZt2XpaNflIlBHxT7VtEPJ3n84wWUJQkKSPiZawCNPna4bg4mffDJ42x",
	"kOXK6ndCFyeSRQuLY4Bq6trrgoi3bg2oZFrEaPCe57mPXMRJBjGpbpyH63K1jj1geaU9jUq/Ohq9Xyk7",
	"WmvhIYJ95Uxm0/8v6E9up3ts+Mo2sU3j2lprfwEAAP//qqdCRD0BAAA=",
}
